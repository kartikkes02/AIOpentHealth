...
export default function OnboardingPage() {
  ...
  const handleSkip = () => {
    if (currentStep === 4) {
      // Skip only available on Medical Records step
      setCurrentStep(5);
    }
  };
  ...
  const submit = useCallback(async () => {
    ...
    const chatRooms = await onboardingSubmit({
            ...
            >
              {currentStep === 1 ? (
                ...
                <HealthConcerns
                  ...
                  isInvalid={
                    touchedFields.healthConcerns && !healthConcerns.trim()
                  }
                />
              ) : currentStep === 3 ? (
                <PersonalInfo
                ...
                <MedicalRecords
                  ...
                  onValueChange={setMedicalRecords}
                />
              ) : (
                <Analysis />
              )}
